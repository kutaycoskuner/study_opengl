...
//	uni_frame.light.diffuse = ss.light.diffuse;
//
//	// light placeholder
//	// --------------------------------------------------------------------------
//	// set active shader
...
//	active_shader->use();
//	// assign uniforms
//	active_shader->setVec3("light.diffuse", ss.light.diffuse);
...
//	(*active_shader).use();
//	// light uniforms
//	Vec3 reduced_light_diffuse = ss.light.diffuse * 0.5f;
...
//	active_shader->setFloat("mix_val", uni_obj.mix_value);
//	active_shader->setVec3("light.position", ss.light.position);
