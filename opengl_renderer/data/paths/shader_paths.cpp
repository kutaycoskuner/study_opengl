...
const std::vector<ShaderPaths> RelativePaths::shader_paths =
{
	...
	,{
		"source/shaders/3.9.axes_vrtx_shader.glsl"
		,"source/shaders/3.9.axes_frag_shader.glsl"
		,"source/shaders/3.9.axes_geo_shader.glsl"
	}
	,{
		"source/shaders/3.9.explode_vrtx_shader.glsl"
		,"source/shaders/3.9.explode_frag_shader.glsl"
		,"source/shaders/3.9.explode_geo_shader.glsl"
	}
	,{
		"source/shaders/3.9.geo_vrtx_shader.glsl"
		,"source/shaders/3.9.geo_frag_shader.glsl"
		,"source/shaders/3.9.geo_geo_shader.glsl"
	}
	,{
		"source/shaders/3.9.normal_vrtx_shader.glsl"
		,"source/shaders/3.9.normal_frag_shader.glsl"
		,"source/shaders/3.9.normal_geo_shader.glsl"
	}
	,{
		"source/shaders/3.10.instance_vrtx_shader.glsl"
		,"source/shaders/3.10.instance_frag_shader.glsl"
	}
	,{
		"source/shaders/3.10.instance02_vrtx_shader.glsl"
		,"source/shaders/3.10.instance02_frag_shader.glsl"
	}
	,{
		"source/shaders/4.1.blinnphong_vrtx_shader.glsl"
		,"source/shaders/4.1.blinnphong_frag_shader.glsl"
	}
	,{
