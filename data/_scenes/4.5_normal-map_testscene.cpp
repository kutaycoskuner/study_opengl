...
void NormalMapTestScene::loadData()
{
    ...
    predefined_scene_elements.back().shader_id                        = ShaderID::Normal02;
    ...
    for (int i = 0; i < model_paths.size(); i++)
    {
        ...
        scene_state.model_element_bools.push_back(ElementBools{.wireframe_mode     = false,
                                                               .depth_testing      = false,
    ...
    if (scene_nodes.size() > 0) scene_nodes[0].transform.scale = Vec3(0.01f, 0.01f, 0.01f);
}
